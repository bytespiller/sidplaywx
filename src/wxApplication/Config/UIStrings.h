...
namespace Strings
{
	inline constexpr const char* const APP_VERSION_TAG("0.20.0"); // Reminder: don't forget to increase. Also, don't forget the final zero for x.y.0 versions.
	...
	namespace Preferences
	{
		...
		inline constexpr const char* const OPT_COMBINED_WAVEFORMS_STRENGTH("Combined waveforms strength");
		inline constexpr const char* const DESC_COMBINED_WAVEFORMS_STRENGTH("Affects how harsh the SID chip sounds. Individual SID chips had different characteristics and there is no canonically \"correct\" setting.\n- Average: average waves (default)\n- Weak: thin waves\n- Strong: wide waves\n\nNote: ongoing playback will stop when changing this setting.");
		inline constexpr const char* const ITEM_COMBINED_WAVEFORMS_STRENGTH_AVERAGE("Average");
		inline constexpr const char* const ITEM_COMBINED_WAVEFORMS_STRENGTH_WEAK("Weak");
		inline constexpr const char* const ITEM_COMBINED_WAVEFORMS_STRENGTH_STRONG("Strong");
