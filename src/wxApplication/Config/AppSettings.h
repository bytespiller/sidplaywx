...
namespace Settings
{
	...
	public:
		struct ID
		{
			...
			static constexpr const char* const CombinedWaveformsStrength = "CombinedWaveformsStrength";
		...
		enum class CombinedWaveformsStrength
		{
			AVERAGE,
			WEAK,
			STRONG
	...
	public:
		...
		std::vector<Option> GetDefaultSettings() const override
		{
			return
			{
				...
				DefaultOption(ID::CombinedWaveformsStrength, static_cast<int>(CombinedWaveformsStrength::AVERAGE)),
